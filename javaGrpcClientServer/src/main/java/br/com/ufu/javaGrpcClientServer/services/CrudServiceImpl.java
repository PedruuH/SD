...
public class CrudServiceImpl extends CrudServiceImplBase {	
	...
	public void insert(
		...
		System.out.println("Requisição: Insert " + request.getContent());
	}
	...
	public void select(
		...
		System.out.println("Requisição: Select " + ((request.getAll()) ? "*" : request.getId()));
	}	 
	...
	public void update(
		...
		System.out.println("Requisição: Update " + request.getId() + " " + request.getContent());
	}
	...
	public void delete(
		...
		System.out.println("Requisição: Delete " + request.getId());
	}	 
}